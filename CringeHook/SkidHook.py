...
os.system("title Skidhook ✗ ┃ Dev: Gingest ~ Main")
os.system("cls")
...
while option !=0:
    if option ==1:
        os.system("title Skidout ✗ ┃ Dev: Gingest ~ Delete Webhook")
        ...
        os.system("title Skidhook ✗ ┃ Dev: Gingest ~ Spam Webhook")
        ...
        os.system("title Skidhook ✗ ┃ Dev: Gingest ~ Check Webhook")
        ...
        os.system("title Skidhook ✗ ┃ Dev: Gingest ~ Credits")
        os.system("cls")
...
os.system("title Skidhook ✗ ┃ Dev: Gingest ~ Byebye :(")
os.system("cls")
