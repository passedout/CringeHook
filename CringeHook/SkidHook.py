...
while option !=0:
    if option ==1:
        os.system("title Skidout ✗ ┃ Dev: Karma ~ Delete Webhook")
        ...
        os.system("title Skidhook ✗ ┃ Dev: Karma ~ Spam Webhook")
        ...
        while True:
            time.sleep(0)
            webhookurl.send(message + " | https://discord.gg/feared *Spammed with*: 卍**CringeHook**卐", avatar_url="https://cdn.discordapp.com/attachments/958414220926533703/985556711978963004/bleed_transparent.png", username="Skidbot | Github: @RemoteTool")
        ...
        os.system("title Skidhook ✗ ┃ Dev: Karma ~ Check Webhook")
...
os.system("title Skidhook ✗ ┃ Dev: Karma ~ Byebye :(")
os.system("cls")
