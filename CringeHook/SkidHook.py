...
os.system("title Skidhook ✗ ┃ Dev: weebstar ~ Main")
os.system("cls")
...
▐█▄▪▐█▐█.█▌▐█▌██. ██ ██▌▐▀▐█▌.▐▌▐█▌.▐▌▐█.█▌
 ▀▀▀▀ ·▀  ▀▀▀▀▀▀▀▀▀• ▀▀▀ · ▀█▄▀▪ ▀█▄▀▪·▀  ▀
{Fore.BLUE}╚═► {Fore.BLUE}Github: @lemmebe
{Fore.BLUE}╚═► {Fore.CYAN}Telegram: @lemmekms {Fore.RESET}
""")
...
while option !=0:
    if option ==1:
        os.system("title Skidout ✗ ┃ Dev: weebstar ~ Delete Webhook")
        ...
        os.system("title Skidhook ✗ ┃ Dev: weebstar ~ Spam Webhook")
        ...
        os.system("title Skidhook ✗ ┃ Dev: weebstar ~ Check Webhook")
        ...
        os.system("title Skidhook ✗ ┃ Dev: weebstar ~ Credits")
        os.system("cls")
...
os.system("title Skidhook ✗ ┃ Dev: weebstar ~ Byebye :(")
os.system("cls")
